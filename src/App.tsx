  ...
  return (
    <div className="h-screen overflow-hidden flex text-slate-805" style={{ backgroundColor: 'var(--color-bg)', fontFamily: theme?.fontFamily || 'Inter' }} id="app-workspace-layout-canvas">
      ...
      <main className="flex-1 flex flex-col min-w-0 relative h-full overflow-hidden">
        ...
        <div key={activePanel} className="page-transition flex-grow p-3 md:p-8 pb-24 md:pb-8 max-w-7xl w-full mx-auto overflow-y-auto" style={{ fontSize: theme?.fontSize === 'small' ? '0.75rem' : theme?.fontSize === 'large' ? '1rem' : '0.875rem' }}>
