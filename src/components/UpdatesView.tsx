...
export default function UpdatesView({ companyId, updates, cases, onRefresh, onSendUpdate, currentUser }: UpdatesViewProps) {
  ...
  const enrichedCorrespondence: Correspondence[] = correspondenceList.map(corr => {
    ...
    return {
      ...
      isUrgent: corr.isUrgent || corr.priority === 'urgent' || false,
      isPrivileged: corr.isPrivileged || false,
      sourceType: corr.sourceType || 'manual',
      snippetsUsed: corr.snippetsUsed || [],
      variables: corr.variables || {},
      disclaimers: corr.disclaimers || [],
      signatureBlock: corr.signatureBlock || { name: currentUser?.fullName || 'Elena Rostova', title: 'Counsel', firm: 'Docket Law', phone: '+1 555-0192', email: 'counsel@docketlaw.app' },
      ccRecipients: corr.ccRecipients || [],
      bccRecipients: corr.bccRecipients || [],
      secondaryRecipients: corr.secondaryRecipients || [],
      sendTimeOptimized: corr.sendTimeOptimized || false,
      approvalLevel: corr.approvalLevel || 1,
      slaBreached: corr.slaBreached || false,
