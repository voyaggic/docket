      ...
      <div className="bg-white rounded-[24px] w-full max-w-2xl border-2 border-slate-200 shadow-2xl overflow-hidden animate-scale-up text-center flex flex-col">
        ...
        <div className="flex border-b-2 border-slate-200">
          <button
            ...
            className={`flex-1 py-3 text-xs uppercase tracking-wider border-b-2 transition-all duration-200 font-normal ${
              mode === 'manual' 
                ? 'border-[#00BCFF] text-[#00BCFF]' 
          ...
          <button
            ...
            className={`flex-1 py-3 text-xs uppercase tracking-wider border-b-2 flex items-center justify-center gap-1.5 transition-all duration-200 font-normal ${
              mode === 'ai' 
                ? 'border-[#00BCFF] text-[#00BCFF]' 
                : 'border-transparent text-slate-400 hover:text-slate-600 hover:bg-slate-50'
            }`}
            ...
            <div className="w-full p-4 bg-amber-50 border-2 border-amber-200 rounded-2xl space-y-4 text-xs text-center flex flex-col items-center">
              ...
              <div className="flex gap-2 justify-center flex-wrap pt-2">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-[#00BCFF] hover:bg-[#00BCFF]/90 text-white rounded-xl text-[11px] font-normal transition"
                >
                  Save anyway
                </button>
              </div>
              ...
              >
                ...
                <div className="mt-4 flex flex-col items-center justify-center gap-2">
                  <button
                    ...
                    className="bg-[#00BCFF] hover:bg-[#00BCFF]/90 text-white text-xs font-normal py-2.5 px-5 rounded-xl transition-all duration-200 cursor-pointer min-h-[44px]"
                  >
                  ...
                  <button
                    ...
                    disabled={aiExtracting}
                    className="text-[10px] text-slate-400 hover:text-[#00BCFF] underline cursor-pointer mt-1 font-normal transition"
                  >
                    Or use Passport Demo scan template
                  </button>
                  
                  {uploadedFile && (
                    <div className="flex items-center gap-1.5 text-xs text-[#00BCFF] bg-[#00BCFF]/10 px-3 py-1.5 rounded-lg font-mono border-2 border-[#00BCFF]/20 mt-2 animate-fade-in">
                      <FileText className="h-3.5 w-3.5 shrink-0 text-[#00BCFF]" />
                ...
                <div className="grid grid-cols-4 gap-2 w-full">
                  {['individual', 'corporate', 'government', 'ngo'].map(cat => (
                    <button
                      ...
                      className={`py-2 text-[10px] uppercase tracking-wider rounded-xl border-2 transition-all duration-200 cursor-pointer min-h-[44px] ${
                        formData.clientCategory === cat 
                          ? 'bg-[#00BCFF] text-white border-[#00BCFF] shadow-sm font-bold' 
                          : 'bg-slate-50 text-slate-950 font-bold hover:text-slate-900 border-slate-350 hover:border-slate-500'
                      }`}
                    >
                      {cat}
                    </button>
                ...
                <div className="flex flex-col items-center gap-3 w-full max-w-lg mb-5 bg-slate-100/70 p-4 border-2 border-slate-200 rounded-2xl shadow-xxs">
                  <div className="flex items-center justify-between w-full">
                    ...
                    >
                      {aiFieldsLoading ? (
                        <>
                          <Loader2 className="h-3 w-3 animate-spin text-[#00BCFF]" />
                          Analyzing notes...
                        </>
                      ) : (
                        <>
                        ...
                        {aiSuggestedFields.map((field) => {
                          ...
                          return (
                            <button
                              ...
                              className={`text-[10px] px-2.5 py-1.5 rounded-xl border-2 flex items-center gap-1 transition-all duration-150 ${
                                isAlreadyAdded
                                  ? 'bg-slate-200 border-slate-300 text-slate-400 cursor-not-allowed'
                                  : 'bg-white border-sky-200 text-[#00BCFF] hover:bg-sky-50 hover:border-[#00BCFF] font-black shadow-xxs'
                              }`}
                            >
                              <span>+</span>
        ...
        <div className="p-6 border-t-2 border-slate-200 bg-slate-50/50 flex gap-2 justify-center">
          ...
          {!duplicateWarning && (
            <button
              ...
              className="text-xs font-normal bg-[#00BCFF] hover:bg-[#00BCFF]/90 text-white px-6 py-2.5 rounded-xl transition-all duration-200 disabled:opacity-40 flex items-center justify-center gap-1.5 cursor-pointer min-h-[44px]"
            >
